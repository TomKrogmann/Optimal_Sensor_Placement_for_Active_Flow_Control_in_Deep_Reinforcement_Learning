...
from drlfoam.environment import RotatingPinball2D12procs
...
def main(args):
    ...
    copytree(join(BASE_PATH, "openfoam", "test_cases", "rotatingPinball2D/pinball_re100_12procs"),
             join(training_path, "base"), dirs_exist_ok=True)
    env = RotatingPinball2D12procs()
    ...
    if executer == "local":
        ...
        config = SlurmConfig(
            n_tasks=5, n_nodes=1, partition="standard", time="8:00:00",
    ...
    agent.load("/home/y0101545/drlfoam/examples/test_train_re100_12procs_actionmag5_5cores_140interactions_04liftPen/save_first20episodes/policy_19.pkl", "/home/y0101545/drlfoam/examples/test_train_re100_12procs_actionmag5_5cores_140interactions_04liftPen/save_first20episodes/value_19.pkl")    
    ...
    for e in range(episodes):
        ...
        #if len(states) > 1 and len(states) == len(actions):
