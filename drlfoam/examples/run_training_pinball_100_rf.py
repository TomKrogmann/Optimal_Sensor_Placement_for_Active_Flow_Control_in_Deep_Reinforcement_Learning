...
from drlfoam.environment import RotatingPinball2D100RF
...
def main(args):
    ...
    copytree(join(BASE_PATH, "openfoam", "test_cases", "rotatingPinball2D/pinball_re100_rf"),
             join(training_path, "base"), dirs_exist_ok=True)
    env = RotatingPinball2D100RF()
    ...
    agent.load("/home/y0101545/drlfoam/examples/test_train_rf_re100_5procs_actionmag5/save_30_episodes/policy_30.pkl","/home/y0101545/drlfoam/examples/test_train_rf_re100_5procs_actionmag5/save_30_episodes/value_30.pkl")
    # begin training
