...
class RotatingPinball2D30RF(Environment):
    def __init__(self, r1: float = 0.0, r2: float = 0.2):
        super(RotatingPinball2D30RF, self).__init__(
            join(TESTCASE_PATH, "rotatingPinball2D/pinball_re30_rf"), "Allrun.pre",
            "Allrun", "Allclean", 2, 4, 3 # MPI_ranks, n_states, n_actions - changed to 3 
        )
        self._r1 = r1
        self._r2 = r2
