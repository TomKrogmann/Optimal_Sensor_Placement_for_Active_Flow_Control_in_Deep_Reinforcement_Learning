...
class RotatingPinball2D30ATT(Environment):
    def __init__(self, r1: float = 0.0, r2: float = 0.4):
        super(RotatingPinball2D30ATT, self).__init__(
            join(TESTCASE_PATH, "rotatingPinball2D/pinball_re30_attention"), "Allrun.pre",
