...
class RotatingPinball2D12procs(Environment):
    def __init__(self, r1: float = 0.0, r2: float = 0.4):
        super(RotatingPinball2D12procs, self).__init__(
            join(TESTCASE_PATH, "rotatingPinball2D/pinball_re100_12procs"), "Allrun.pre",
