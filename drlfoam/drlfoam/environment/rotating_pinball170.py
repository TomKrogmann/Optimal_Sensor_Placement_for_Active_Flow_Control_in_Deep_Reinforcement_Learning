...
class RotatingPinball2D170(Environment):
    def __init__(self, r1: float = 0.0, r2: float = 0.2):
        super(RotatingPinball2D170, self).__init__(
            join(TESTCASE_PATH, "rotatingPinball2D/pinball_re170"), "Allrun.pre",
